...
flags.DEFINE_string("checkpoint_dir", "8_full_checkpoints", "Directory name to save the checkpoints [checkpoint]")
flags.DEFINE_string("sample_dir", "8_full_samples", "Directory name to save the image samples [samples]")
